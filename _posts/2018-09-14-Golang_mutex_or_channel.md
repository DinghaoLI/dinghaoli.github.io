---
layout: post
title:  "Golang中通道和锁的对比"
date:   2018-09-14 23:33:33 +0800
categories: Golang
tags: Golang
...
当不同goroutine对同一个资源发生竞争时，经典的解决方案时需要用锁去保护，以防止读写操作冲突，维护数据一致性。比如经典的任务模型：  
...
参考：
[The_way_to_go](https://github.com/Unknwon/the-way-to-go_ZH_CN/blob/master/eBook/14.7.md)
